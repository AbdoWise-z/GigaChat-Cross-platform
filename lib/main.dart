      ...
      child: Consumer<ThemeProvider>(
        builder: (_ , val , __) {
          ...
          return MaterialApp(
            theme: val.getTheme,
            title: "GigaChat",
            //home: const SimpleExampleApp(),
            initialRoute: widget.initialRoute ?? CreatePostPage.pageRoute,
            routes: {
              "/tmp" : (context) => const SimpleExampleApp(),
              ...
              CreatePostPage.pageRoute : (context) => CreatePostPage(),
            },
          );
        },
      ),
